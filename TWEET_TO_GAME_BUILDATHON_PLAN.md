...
- Cloudflare D1：保存 run、Agent 事件、BossSpec、eval 和生成历史
- Cloudflare R2：保存生成语音、音乐和其他文件 artifact
- Cloudflare Pages/Tunnel：公开页面和本地 runner 入口
...
2. **Cloudflare**：Pages、Tunnel、D1 和 R2 共同承担公开交付与持久化
...
| 06:30–07:00 | Cloudflare Pages、D1/R2、访问统计 |
